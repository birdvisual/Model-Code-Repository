...
class Attention(Module):
    def __init__(
        ...
        self.mem_kv = nn.Parameter(torch.randn(2, self.heads, num_mem_kv, dim_head)) # 为注意力机制引入可学习的“记忆”键值对
...
class MaxViT(Module):
    def __init__(
        ...
        *,
        ...
        dim_conv_stem = default(dim_conv_stem, dim) #第一个特征提取层的维度值，dim_conv_stem存在就用它，否则用dim
